...
export const elf_shdr = {
  ...
  sh_flags: {
    ...
    0x200000:
      "SHF_GNU_RETAIN" /* Section should not be garbage collected by the linker.  */,
    0xf0000000: "SHF_MASKPROC" /* Processor-specific semantics */,
    0x80000000:
      "SHF_EXCLUDE" /* Link editor is to exclude this section from executable and shared library that it builds when those objects are not to be further relocated.  */,
...
DT_FLAGS_1[1 << 3] =
  "DF_1_NODELETE"; /* Object cannot be deleted from a process. */
DT_FLAGS_1[1 << 4] = "DF_1_LOADFLTR"; /* Ensure immediate loading of filtees. */
DT_FLAGS_1[1 << 5] =
  "DF_1_INITFIRST"; /* Objects' initialization occurs first. */
DT_FLAGS_1[1 << 6] =
  "DF_1_NOOPEN"; /* Object can not be used with dlopen(3DL). */
...
DT_FLAGS_1[1 << 12] =
  "DF_1_NODUMP"; /* Object cannot be dumped with dldump(3DL) */
DT_FLAGS_1[1 << 13] =
  "DF_1_CONFALT"; /* Object is a configuration alternative. */
...
DT_FLAGS_1[1 << 17] =
  "DF_1_NODIRECT"; /* Do not create dynamic relocations for references to external symbols. */
DT_FLAGS_1[1 << 18] =
  "DF_1_IGNMULDEF"; /* Ignore multiple definitions of the same symbol. */
DT_FLAGS_1[1 << 19] =
  "DF_1_NOKSYMS"; /* Object does not participate in symbol resolution. */
DT_FLAGS_1[1 << 20] = "DF_1_NOHDR"; /* Object does not have an ELF header. */
DT_FLAGS_1[1 << 21] =
  "DF_1_EDITED"; /* Object has been edited by runtime linker. */
DT_FLAGS_1[1 << 22] = "DF_1_NORELOC"; /* Do not perform relocations. */
DT_FLAGS_1[1 << 23] =
  "DF_1_SYMINTPOSE"; /* Object has symbols that are subject to interposition. */

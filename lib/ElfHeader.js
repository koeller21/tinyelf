...
exports.ElfHeader = void 0;
var common_1 = require("./constants/common");
// EI_NIDENT is typically defined as 16
var EI_NIDENT = 16;
var ElfHeader = /** @class */ (function (_super) {
    __extends(ElfHeader, _super);
    function ElfHeader(data) {
        var _this = _super.call(this, data) || this;
        _this.header.e_ident = _this.parse_e_ident();
        _this.bit = ((_this.header.e_ident.EI_CLASS.value == "ELFCLASS32") ? 32 : 64);
        _this.endianness = (_this.header.e_ident.EI_DATA.value == "ELFDATA2LSB");
        _this.parse_ehdr();
        return _this;
    }
    ElfHeader.prototype.parse_e_ident = function () {
        var dataReader = new common_1.ElfDataReader(this.data, 0);
        /*
        The first byte of the magic number.  It must be filled with ELFMAG0.  (0: 0x7f)
        */
        var EI_MAG0 = dataReader.readData("EI_MAG0", common_1.Elf32Types.char);
        /*
        The second byte of the magic number.  It must be filled with ELFMAG1.  (1: 'E')
        */
        var EI_MAG1 = dataReader.readData("EI_MAG1", common_1.Elf32Types.char);
        /*
        The third byte of the magic number.  It must be filled with ELFMAG2.  (2: 'L')
        */
        var EI_MAG2 = dataReader.readData("EI_MAG2", common_1.Elf32Types.char);
        /*
        The fourth byte of the magic number.  It must be filled with ELFMAG3.  (3: 'F')
        */
        var EI_MAG3 = dataReader.readData("EI_MAG3", common_1.Elf32Types.char);
        // check if magic numbers are correct, if not, abort
        if (EI_MAG0.value != 127 || EI_MAG1.value != 69 || EI_MAG2.value != 76 || EI_MAG3.value != 70) {
            var err = new Error("This does not appear to be an ELF-Binary - Magic numbers are wrong");
            throw err;
        }
        /*
        ToDo:
        ...
        */
        var EI_CLASS = dataReader.readData("EI_CLASS", common_1.Elf32Types.char, common_1.e_ident.EI_CLASS);
        // check if class is invalid, if yes, abort
        if (EI_CLASS.value == "ELFCLASSNONE" || EI_CLASS.value == null) {
            var err = new Error("None or invalid ELF-File Class: " + EI_CLASS.value);
            throw err;
        }
        /*
        The sixth byte specifies the data encoding of the processor-specific data in the file.
        */
        var EI_DATA = dataReader.readData("EI_DATA", common_1.Elf32Types.char, common_1.e_ident.EI_DATA);
        // check if data encoding is invalid, if yes, abort
        if (EI_DATA.value == "ELFDATANONE" || EI_DATA.value == null) {
            var err = new Error("None or invalid ELF-File Data Encoding: " + EI_DATA.value);
            throw err;
        }
        /*
        The seventh byte is the version number of the ELF specification:
        */
        var EI_VERSION = dataReader.readData("EI_VERSION", common_1.Elf32Types.char, common_1.e_ident.EI_VERSION);
        /*
        ...
        */
        var EI_OSABI = dataReader.readData("EI_OSABI", common_1.Elf32Types.char, common_1.e_ident.EI_OSABI);
        /*
        ...
        */
        var EI_ABIVERSION = dataReader.readData("EI_ABIVERSION", common_1.Elf32Types.char);
        /*
        ...
        are given meanings.
        */
        var EI_PAD = dataReader.readData("EI_PAD", 6);
        /*
        The size of the e_ident array.
        */
        var EI_NIDENT = dataReader.readData("EI_NIDENT", 1);
        var e_ident_entries = {
            EI_MAG0: EI_MAG0,
            EI_MAG1: EI_MAG1,
            EI_MAG2: EI_MAG2,
    ...
    ElfHeader.prototype.parse_ehdr = function () {
        var dtype = 0;
        var dataReader = new common_1.ElfDataReader(this.data, EI_NIDENT);
        /* This member of the structure identifies the object file type */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_type = dataReader.readData("e_type", dtype, common_1.elf_hdr.e_type);
        /* This member of the structure identifies the object file type */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_machine = dataReader.readData("e_machine", dtype, common_1.elf_hdr.e_machine);
        /* This member of the structure identifies the object file type */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Word : common_1.Elf64Types.Elf_Word;
        var e_version = dataReader.readData("e_version", dtype, common_1.elf_hdr.e_version);
        /*
        ...
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Addr : common_1.Elf64Types.Elf_Addr;
        var e_entry = dataReader.readData("e_entry", dtype);
        /*
        This member holds the program header table's file offset in bytes.
        If the file has no program header table, this member holds zero.
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Off : common_1.Elf64Types.Elf_Off;
        var e_phoff = dataReader.readData("e_phoff", dtype);
        /*
        This member holds the section header table's file offset in bytes.
        If the file has no section header table, this member holds zero.
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Off : common_1.Elf64Types.Elf_Off;
        var e_shoff = dataReader.readData("e_shoff", dtype);
        /*
        This member holds processor-specific flags associated with the file.
        Flag names take the form EF_`machine_flag'.  Currently, no flags have been defined.
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Word : common_1.Elf64Types.Elf_Word;
        var e_flags = dataReader.readData("e_flags", dtype);
        /*
        This member holds the ELF header's size in bytes.
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_ehsize = dataReader.readData("e_ehsize", dtype);
        /*
        This member holds the size in bytes of one entry in the file's program header table;
        all entries are the same size.
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_phentsize = dataReader.readData("e_phentsize", dtype);
        /*
        ...
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_phnum = dataReader.readData("e_phnum", dtype);
        /*
        ...
        */
        if (e_phnum.raw_hex >= common_1.elf_hdr["PN_XNUM"]) {
        ...
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_shentsize = dataReader.readData("e_shentsize", dtype);
        /*
        ...
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_shnum = dataReader.readData("e_shnum", dtype);
        /*
        ...
        entry in section header table.
        */
        if (e_shnum.raw_hex >= common_1.elf_hdr["SHN_LORESERVE"]) {
            e_shnum.value = 0;
            e_shnum.raw_dec = 0x0;
            e_shnum.raw_hex = 0x0;
        }
        ...
        */
        dtype = this.bit == 32 ? common_1.Elf32Types.Elf_Half : common_1.Elf64Types.Elf_Half;
        var e_shstrndx = dataReader.readData("e_shstrndx", dtype);
        /*
        ...
        */
        if (e_shstrndx.raw_hex == common_1.elf_hdr["SHN_UNDEF"]) {
            e_shstrndx.value = common_1.elf_hdr.e_shstrndx[0]; //SHN_UNDEF
        }
        else if (e_shstrndx.raw_hex >= common_1.elf_hdr["SHN_LORESERVE"]) {
            e_shstrndx.value = common_1.elf_hdr.e_shstrndx[0xffff]; // SHN_XINDEX
        }
